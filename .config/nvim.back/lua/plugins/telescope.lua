return { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
      ...
      defaults = {
        ...
        layout_config = {
          horizontal = {
            ...
            preview_width = 0.5, -- Increase this value to make the preview wider
    ...
    vim.keymap.set("n", "<leader><leader>", require("telescope").extensions.menufacture.find_files)
    vim.keymap.set("n", "<leader>ss", builtin.builtin, { desc = "[S]earch [S]elect Telescope" })
    vim.keymap.set("n", "<leader>sw", builtin.grep_string, { desc = "[S]earch current [W]ord" })
    vim.keymap.set('n', '<leader>/', require('telescope').extensions.menufacture.live_grep, {desc="[S]earch by [G]rep with Filter"})
